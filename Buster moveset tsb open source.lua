...
\ `\`\\/'/\ \ \/\ \ \ \   
 `\ `\ /'  \ \ \ \ \ \ \  
   `\ \ \   \ \ \_\ \ \_\ 
     \ \_\   \ \_____\/\_\
      \/_/    \/_____/\/_/]]
--[[Yo! If you're gonna use this script as a template, PLEASE, this is the LEAST you could do for US, please credit both Kabapa and SeaBlue for this script, thanks!
also, i cannot fathom my hatred for this script due to the fact that this script is so "hard" to obfuscate and kept giving me a 'Unknown Token!' Error and i'd extremely
appreciate any help. dm me on discord (oxak11321) if you need help]]

--[['Script ""Guidelines"" and/or etiquette' (again, this is the LEAST you could do for us)
You are ALLOWED to:
-Edit this script
-Make forks of this script
-Publish your own version of this script
You are REQUIRED to
-Credit Kabapa AND SeaBlue]]
